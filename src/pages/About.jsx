...
const About = () => {
  return (
    <div className="min-h-screen bg-gray-100 py-10 px-4 sm:px-6 lg:px-20 mt-20">
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg p-8 space-y-8">
        <h1 className="text-4xl font-bold  text-center">About KenaKata.com</h1>

        <p className="text-gray-700 text-lg">
          Welcome to{" "}
          <span className="font-semibold text-red-600">KenaKata.com</span>, your
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-700 text-base">
            At KenaKata.com, our mission is to make innovative technology
        ...
        <div className="space-y-6">
          ...
          <p className="text-gray-700 text-base">
            ...
            KenaKata.com, we’re committed to staying ahead of the curve,
            offering cutting-edge solutions that are both practical and
            affordable.
          </p>
        </div>
        ...
        <div className="text-center mt-10">
          <h3 className="text-xl font-semibold text-red-600 mb-2">
            Join the KenaKata.com Family
          </h3>
          <p className="text-gray-700 mb-4">
            Whether you’re a tech enthusiast, a professional, or just looking
            for something cool and functional — KenaKata.com has something for
            everyone.
          </p>
        </div>
      </div>
